...
contract("Dex", accounts => {
    // The user must have ETH deposited such that deposited ETH >= BUY order value (this is token buyer)
    ...
    // The user must have enough tokens deposited such that token balance >= SELL order amount (this is token seller)
